...
public class Generator {
     ...
     * 包名
     */
    private static final String PACKAGE_NAME = "com.sponger";
    /**
     * 模块名称
     */
    private static final String MODULE_NAME = "consumer";
    /**
     * 输出文件的路径
     */
    private static final String OUT_PATH = "F:\\IntellijWorkSpace\\generator\\src\\main\\java";
    /**
     * mapper.xml的路径
     */
    private static final String XML_PATH = "F:\\IntellijWorkSpace\\generator\\src\\main\\java\\com\\sponger\\consumer\\dao\\mapper";
    /**
     * 代码生成者
     */
    private static final String AUTHOR = "sponger";
                            ...
                            public void initMap() {
                                ...
                                Collections.<FileOutConfig>singletonList(new FileOutConfig("/templates/mapper.xml.vm") {
                                    ...
                                    public String outputFile(TableInfo tableInfo) {
                                        File xmlDir = new File(XML_PATH);
                                        if(xmlDir.exists()){
                                            if(!xmlDir.isDirectory()){
                                                System.err.println(XML_PATH +  "不是文件夹");
                                            }
                                        }else{
                                            xmlDir.mkdir();
                                        }
                                        return XML_PATH + "/" +tableInfo.getEntityName() + "Mapper.xml";
                                    }
                                })))
                .setTemplate(
